/*
   ...
   This decoder uses external interrupts so pins D2 or D3 must be used in 
   case of the ATMEGA328P. Make sure to adjust PPM_CHANNELS to the number of 
   channels used by the system to decode.
   
   This code is under "THE BEERWARE LICENSE" (Revision 42):
